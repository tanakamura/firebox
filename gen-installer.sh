...
USE0="$USE0 -static-analyzer -memprof -compiler-rt -profile -xray -sanitize -e2fsprog -kmod"
USE0="$USE0 X minimal -gdbm evdev udev xvfb lto"
...
#emerge --update --deep --newuse $A xorg-server gtk+
emerge xterm
