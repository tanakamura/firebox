exec qemu-system-x86_64 -kernel bzImage -initrd firebox_initrd.zstd -m 2G -serial mon:stdio -nic bridge,id=br0 -smp 4 -machine type=q35,accel=kvm -append "console=ttyS0"
